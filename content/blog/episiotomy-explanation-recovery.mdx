...
**Paracetamol and ibuprofen** are both considered compatible with breastfeeding according to NHS guidance, and they are what maternity units most commonly suggest after a tear or episiotomy. Ask your midwife, GP or pharmacist what is appropriate for you, and follow the dosing on the packet — how much and how often depends on your own circumstances, including any other medication you take. Staying ahead of the pain rather than waiting until it becomes severe generally gives steadier control, and the two medicines work through different mechanisms, which is why clinicians sometimes advise using both.
