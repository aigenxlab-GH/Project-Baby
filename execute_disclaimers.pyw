#!/usr/bin/env python3
"""
Execute disclaimer processing directly
This is a .pyw file to run without console window
"""
...
# Execute the main processing script directly
if __name__ == '__main__':
    # Import and run the processing logic directly
