...
export const PRODUCT_CATEGORY_IMAGES: Record<string, string> = {
  ...
  monitors:            U('photo-1713857297379'),  // "a smart phone sitting next to a wireless security camera"
  'breast-pumps':      U('photo-1751890855898'),  // "A baby breastfeeds, clinging to its mother"
  'high-chairs':       U('photo-1557939663'),     // "a baby sitting in a high chair eating food"
