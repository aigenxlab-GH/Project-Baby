export const mainNav = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Hospital Bag Checklist', href: '/tools/hospital-bag-checklist' },
      { title: 'Feeding Schedule Tracker', href: '/tools/feeding-schedule-tracker' },
      { title: 'Growth Percentile Calculator', href: '/tools/growth-percentile-calculator' },
