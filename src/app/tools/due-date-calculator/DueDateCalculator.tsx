        ...
        <div className="flex gap-2 flex-wrap">
          {([
            ...
            <button
              ...
              className={`px-4 py-2.5 rounded-full text-sm font-medium transition-colors ${method === m.id ? 'bg-brand-600 text-white' : 'bg-white dark:bg-gray-700 text-gray-600 dark:text-gray-300 hover:bg-brand-50 dark:hover:bg-brand-950/40 border border-gray-200 dark:border-gray-600'}`}
            >
              {m.label}
            </button>
          ))}
