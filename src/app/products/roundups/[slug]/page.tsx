...
interface RoundupProduct {
  ...
  image: string;
  imageAlt: string;
  // Optional: only set when a matching live Sanity product review actually
  // exists. Most of these were hand-authored slugs guessing at a review
  // page that was never created — omit rather than link to a 404 or,
  // worse, silently link to a different product that happens to share a
  // brand name.
  reviewSlug?: string;
  category: string;
  pros: string[];
    ...
    products: [
      {
        ...
        reviewSlug: '/products/strollers/bugaboo-fox-5-all-terrain-pram-stroller',
        category: 'strollers',
      ...
      },
      {
        ...
        reviewSlug: '/products/strollers/baby-jogger-city-mini-gt2-single-stroller',
        category: 'strollers',
    ...
    products: [
      {
        ...
        reviewSlug: '/products/strollers/ergobaby-omni-360-all-position-baby-carrier',
      ...
      },
      {
        ...
        reviewSlug: '/products/baby-carriers/babybjorn-baby-carrier-one-air',
        category: 'baby-carriers',
  ...
  'best-baby-bouncers-2026': {
    ...
    products: [
      ...
      },
      {
        ...
        reviewSlug: '/products/baby-bouncers/ergobaby-evolve-3-in-1-bouncer',
        category: 'baby-bouncers',
      ...
      },
      {
        ...
        reviewSlug: '/products/baby-bouncers/babybjorn-bouncer-bliss',
        category: 'baby-bouncers',
