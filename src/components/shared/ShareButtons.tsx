  ...
  return (
    <div className="flex items-center gap-2 flex-wrap">
      ...
      <a
        ...
        className="flex items-center gap-1.5 text-xs font-medium px-3 py-2.5 rounded-full bg-red-50 text-red-700 hover:bg-red-100 transition-colors"
      >
        {/* Pinterest P icon */}
      ...
      <a
        ...
        className="flex items-center gap-1.5 text-xs font-medium px-3 py-2.5 rounded-full bg-sky-50 text-sky-700 hover:bg-sky-100 transition-colors"
      >
        <svg className="h-3.5 w-3.5 fill-current" viewBox="0 0 24 24" aria-hidden="true">
      ...
      <a
        ...
        className="flex items-center gap-1.5 text-xs font-medium px-3 py-2.5 rounded-full bg-blue-50 text-blue-700 hover:bg-blue-100 transition-colors"
      >
        <svg className="h-3.5 w-3.5 fill-current" viewBox="0 0 24 24" aria-hidden="true">
      ...
      <button
        ...
        className="flex items-center gap-1.5 text-xs font-medium px-3 py-2.5 rounded-full bg-gray-100 text-gray-600 hover:bg-gray-200 transition-colors"
      >
