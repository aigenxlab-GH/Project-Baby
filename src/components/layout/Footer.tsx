...
// Only platforms with a live account. These render as footer links AND are
// emitted as Organization sameAs, so a dead entry is both a 404 for readers
// and an unsupported claim to Google. Keep in sync with siteConfig.social.
const socialLinks = [
  {
    name: 'Pinterest',
